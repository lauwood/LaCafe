...
struct ImGuiStyle
{
    ...
    ImVec2      DisplaySafeRestaurantPadding;     // If you cannot see the edge of your screen (e.g. on a TV) increase the safe area padding. Covers popups/tooltips as well regular windows.
